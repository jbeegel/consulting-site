...
const HOT_WORDS = /\b(dewalt|milwaukee|makita|bosch|snap-?on|festool|stihl|husqvarna|honda|yamaha|generac|kohler|rolex|omega|seiko|tag heuer|breitling|cartier|tiffany|louis vuitton|gucci|coach|prada|chanel|hermes|gold|silver|sterling|platinum|diamond|karat|\d+k\b|bullion|coin|morgan|eagle|krugerrand|lego|nintendo|playstation|ps5|xbox|switch|pokemon|magic the gathering|funko|apple|iphone|ipad|macbook|imac|samsung|sony|canon|nikon|leica|bose|sonos|dyson|kitchenaid|vitamix|herman miller|aeron|steelcase|eames|knoll|mid.?century|yeti|weber|traeger|big green egg|gibson|fender|martin|taylor|roland|marshall|trek|specialized|cannondale|giant|peloton|john deere|kubota|cat\b|caterpillar|toro|ego\b|ryobi|garmin|dji|gopro|oculus|quest|vintage|antique|signed|first edition|rare)\b/gi;
